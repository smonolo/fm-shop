  ...
  return (
    <section className="mx-auto w-full max-w-[1400px] px-4 pt-20 sm:px-8 md:px-20">
      ...
      <LinkButton
        ...
        className="flex w-full items-center justify-center gap-2 rounded-full bg-fm-aqua px-6 py-2.5 text-fm-dark shadow-fm-aqua transition-colors duration-500 hover:bg-fm-cyan sm:hidden"
      />
    </section>
  )
}
